...
const LicenseSchema = new Schema({
  ...
  billingPeriod: {
    ...
    // ✅ null quebra enum no Mongoose; undefined não valida e mantém o campo ausente até contratar plano
    default: undefined,
    // ✅ blindagem: se vier null (ou vazio), remove o campo em vez de invalidar
